...
<script>
    document.getElementById("contactForm").addEventListener("submit", function(event) {
        ...
        var emailBody = "Jméno: " + formData.get("name") + "\n";
        emailBody += "Email: " + formData.get("email") + "\n";
        emailBody += "Předmět: " + formData.get("subject") + "\n";
        emailBody += "Zpráva: " + formData.get("message");

       
        window.location.href = "mailto:mastnyv.04@spst.eu?subject=Kontaktní formulář&body=" + encodeURIComponent(emailBody);
    });
</script>
